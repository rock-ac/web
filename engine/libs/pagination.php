...
class paginationLibrary {
	...
	public function render() {
		...
		if ($num_pages > 1) {
			...
			if ($start > 1) {
				$output .= '<li class="page-item"><a class="page-link" href="' . str_replace('{page}', 1, $this->url) . '">...</a></li>';
			}
			...
			if ($end < $num_pages) {
				$output .= '<li class="page-item"><a class="page-link" href="' . str_replace('{page}', $num_pages, $this->url) . '">...</a></li>';
			}
		}
