<?php echo $header ?>
				<div class="pb-2 mt-4 mb-2">
					<h2>Лог модуля #<?php echo $log['id']?></h2>
				</div>
				<div class="card mb-4">
					...
					<div class="card-body">
						<table class="table mb-0">
                            ...
                            <tr>
								<th>Базовый адрес:</th>
                                <td title="Адрес памяти, куда был загружен модуль"><?php echo "0x" . dechex($log['base_address']) . " (dec: " . $log['base_address'] .  ")"; ?></td>
							</tr>
                            <tr>
								<th>Издатель:</th>
                                <td>
                                ...
                                {
                                    case "NONE":
                                        echo "Неизвестен, либо файл не имеет подписанного сертификата.";
                                        break;
